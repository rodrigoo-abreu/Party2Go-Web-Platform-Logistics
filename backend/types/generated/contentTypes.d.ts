...
export interface ApiClientClient extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    client_id: Schema.Attribute.UID;
    ...
    > &
      Schema.Attribute.Private;
    nif: Schema.Attribute.BigInteger;
    number_floor: Schema.Attribute.String;
...
export interface ApiCourierCourier extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    courier_id: Schema.Attribute.UID;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email;
...
export interface ApiDeliveryProofDeliveryProof
  extends Struct.CollectionTypeSchema {
  collectionName: 'delivery_proofs';
  info: {
    description: 'Stores proof of delivery including location, photo, and signature.';
    displayName: 'Delivery Proof';
    pluralName: 'delivery-proofs';
    singularName: 'delivery-proof';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiMessageMessage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    sender: Schema.Attribute.Enumeration<['admin', 'courier', 'client']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    classification: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    client_id: Schema.Attribute.Relation<'manyToOne', 'api::client.client'>;
    collection_address: Schema.Attribute.String;
    combos: Schema.Attribute.JSON;
    courier_id: Schema.Attribute.Relation<'manyToOne', 'api::courier.courier'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    date_collection: Schema.Attribute.DateTime;
    date_delivery: Schema.Attribute.DateTime;
    delivery_duration: Schema.Attribute.Integer;
    ended_at: Schema.Attribute.DateTime;
    image: Schema.Attribute.Media<'images'>;
    intructions: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::order.order'> &
      Schema.Attribute.Private;
    notes: Schema.Attribute.Text;
    num_products: Schema.Attribute.Integer;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    minTime: Schema.Attribute.String;
    price: Schema.Attribute.Decimal;
...
export interface ApiVehicleIdVehicleId extends Struct.CollectionTypeSchema {
  collectionName: 'vehicle_ids';
  info: {
    displayName: 'Vehicle';
    pluralName: 'vehicle-ids';
    singularName: 'vehicle-id';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    licence_plate: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::vehicle-id.vehicle-id'
    > &
      Schema.Attribute.Private;
    max_dimensions: Schema.Attribute.JSON;
    max_weight: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    tags: Schema.Attribute.JSON;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    vehicle_id: Schema.Attribute.UID;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::delivery-proof.delivery-proof': ApiDeliveryProofDeliveryProof;
      'api::message.message': ApiMessageMessage;
      'api::order.order': ApiOrderOrder;
      'api::password-reset-token.password-reset-token': ApiPasswordResetTokenPasswordResetToken;
      'api::product.product': ApiProductProduct;
      'api::vehicle-id.vehicle-id': ApiVehicleIdVehicleId;
